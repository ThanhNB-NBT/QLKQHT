    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="breadcrumb mb-0 p-0 float-right">
                                ...
                                <li class="breadcrumb-item"><span>Sinh viên - Lớp học</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-8 col-8 text-right add-btn-col">
                        <a href="javascript:void(0);" class="btn btn-primary btn-rounded"
                           data-toggle="modal" data-target="#add_student_class">
                            <i class="fas fa-plus"></i> Thêm Sinh viên - Lớp học
                        </a>
                    </div>
                </div>
                <div class="content-page">
                    <form action="TeacherStudentClassServlet" method="GET">
                        <div class="row filter-row">
                            <div class="col-sm-8 col-md-3">
                                <div class="form-group form-focus">
                                    <input type="text" name="studentName" class="form-control floating">
                                    ...
                                    <tbody>
                                        <c:choose>
                                            <c:when test="${not empty studentClasses}">
                                                <c:forEach var="studentClass" items="${studentClasses}" varStatus="number">
                                                    <tr>
                                                            ...
                                                            <div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item edit-student-class"
                                                                       ...
                                                                       data-status="${studentClass.status}">
                                                                       <i class="fas fa-pencil-alt m-r-5"></i> Sửa
                                                                    </a>
                                                                    <a class="dropdown-item delete-student-class"
                                                                       data-id="${studentClass.studentClassID}">
                ...
                <jsp:include page="addTeacherStudentClassModal.jsp"></jsp:include>
                <jsp:include page="deleteTeacherStudentClassModal.jsp"></jsp:include>
                <jsp:include page="editTeacherStudentClassModal.jsp"></jsp:include>
            </div>
        </div>
    </div>

    <jsp:include page="../../../includes/footer.jsp"></jsp:include>
    <script src="${pageContext.request.contextPath}/Views/Teacher/TeacherStudentClassView/TeacherStudentClassJS.js?v=<%= System.currentTimeMillis() %>"></script>
</body>
</html>
